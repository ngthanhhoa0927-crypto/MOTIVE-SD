...
notificationRouter.get("/", authMiddleware, adminMiddleware, async (c) => {
    try {
        ...
        const signedNotifications = await Promise.all(allNotifications.map(async (notif) => {
...
notificationRouter.get("/unread-count", authMiddleware, adminMiddleware, async (c) => {
    try {
...
notificationRouter.put("/:id/read", authMiddleware, adminMiddleware, async (c) => {
    try {
